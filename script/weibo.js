...
[Script]
# > 微博签到
获取token = type=http-request,pattern=https:\/\/api\.weibo\.cn\/\d\/users\/show,script-path=https://raw.githubusercontent.com/sfmeattt/sfmeat/master/script/weibo.js
获取ck    = type=http-request,pattern=https:\/\/api\.weibo\.cn\/2\/logservice\/attach,script-path=https://raw.githubusercontent.com/sfmeattt/sfmeat/master/script/weibo.js

微博签到 = type=cron,cronexp=0 6 7 * * *,wake-system=1,script-path=https://raw.githubusercontent.com/sfmeattt/sfmeat/master/script/weibo.js,script-update-interval=0, timeout=300
