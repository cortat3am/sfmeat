...
Surge
[Script]
获取Token = type=http-response,pattern=^https:\/\/account\.huami\.com\/v2\/client\/login, requires-body=1, max-size=0, script-path=https://raw.githubusercontent.com/sfmeattt/sfmeat/master/script/xmbs.js

小米运动 = type=cron,cronexp=0 1 8 * * *,wake-system=1,script-path=https://raw.githubusercontent.com/sfmeattt/sfmeat/master/script/xmbs.js,script-update-interval=0, timeout=300
